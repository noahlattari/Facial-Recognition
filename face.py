...
class Face:
    ...
    def load_unknown_file_ny_name(self, name):
    ...
    def recognize(self, unknown_filename):
        ...
        unknown_image = face_recognition.load_image_file(self.load_unknown_file_ny_name(unknown_filename))
        ...
        for matched in results:
            if matched:
                #so we foiund the user with index key
                user_id = self.load_user_by_index_key()
                return user_id
